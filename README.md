...
```sh
$ cd ~/YOUR_WS/src
$ git clone git@github.com:chaos-whoi/blueprint_oculus_sonar.git
...
This repository is modified version of [GSO-soslab] https://github.com/GSO-soslab/blueprint_oculus_sonar, built on the [ENSTABretagneRobotics](https://github.com/ENSTABretagneRobotics/oculus_ros2) ROS2 driver for the Blueprint Oculus Driver to suit our needs. We really appreciate their work.